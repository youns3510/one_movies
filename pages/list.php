								...
								<div class="agile-news-table">
									...
									<table id="table-breakpoint">
										...
										<tbody>
										  <tr>
											<td>1</td>
											<td class="w3-list-img"><a href="<?php echo $host;?>pages/single.php"><img src="<?php echo $host;?>partials/images/n1.jpg" alt="" /> <span>01 Ben-Hur</span></a></td>
											<td>2013</td>
											<td>HD</td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">United Kingdom</a></td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/comedy.php">Comedy, Drama</a></td>
											<td>7.0</td>
										  </tr>
										  <tr>
											<td>2</td>
											<td class="w3-list-img"><a href="<?php echo $host;?>pages/single.php"><img src="<?php echo $host;?>partials/images/n2.jpg" alt="" /> <span>001 Southside with you</span></a></td>
											<td>2011</td>
											<td>HD</td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">Korea</a></td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">Drama</a></td>
											<td>7.5</td>
										  </tr>
										  <tr>
											<td>3</td>
											<td class="w3-list-img"><a href="<?php echo $host;?>pages/single.php"><img src="<?php echo $host;?>partials/images/n11.jpg" alt="" /> <span>12 Bad Moms</span></a></td>
											<td>2010</td>
											<td>SD</td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">United Kingdom</a></td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/comedy.php">Comedy</a></td>
											<td>6.5</td>
										  </tr>
										  <tr>
											<td>4</td>
											<td class="w3-list-img"><a href="<?php echo $host;?>pages/single.php"><img src="<?php echo $host;?>partials/images/n3.jpg" alt="" /> <span>2 Sausage Party</span></a></td>
											<td>2013</td>
											<td>HD</td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">United Kingdom</a></td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/comedy.php">Comedy, Drama</a></td>
										  ...
										  <tr>
											<td>5</td>
											<td class="w3-list-img"><a href="<?php echo $host;?>pages/single.php"><img src="<?php echo $host;?>partials/images/n4.jpg" alt="" /> <span>2.0 Morgan</span></a></td>
											<td>2014</td>
											<td>HD</td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">United States</a></td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">Action</a></td>
											<td>7.1</td>
										  </tr>
										  <tr>
											<td>6</td>
											<td class="w3-list-img"><a href="<?php echo $host;?>pages/single.php"><img src="<?php echo $host;?>partials/images/n5.jpg" alt="" /> <span>24</span></a></td>
											<td>2016</td>
											<td>HD</td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">India</a></td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">Thriller, Drama</a></td>
											<td>9.0</td>
										  </tr>
										  <tr>
											<td>7</td>
											<td class="w3-list-img"><a href="<?php echo $host;?>pages/single.php"><img src="<?php echo $host;?>partials/images/n6.jpg" alt="" /> <span>001 The Secret Life of Pets</span></a></td>
											<td>2012</td>
											<td>HD</td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">Euro, France</a></td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">Thriller, Crime, Drama</a></td>
											<td>8.2</td>
										  </tr>
										  <tr>
											<td>8</td>
											<td class="w3-list-img"><a href="<?php echo $host;?>pages/single.php"><img src="<?php echo $host;?>partials/images/n7.jpg" alt="" /> <span>12 Hell or High Water</span></a></td>
											<td>2010</td>
											<td>HD</td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">China</a></td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/comedy.php">Comedy</a></td>
											<td>8.9</td>
										  </tr>
										  <tr>
											<td>9</td>
											<td class="w3-list-img"><a href="<?php echo $host;?>pages/single.php"><img src="<?php echo $host;?>partials/images/n8.jpg" alt="" /> <span>2 Central Intelligence</span></a></td>
											<td>2010</td>
											<td>HD</td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">United Kingdom</a></td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/comedy.php">Comedy, Drama</a></td>
										  ...
										  <tr>
											<td>10</td>
											<td class="w3-list-img"><a href="<?php echo $host;?>pages/single.php"><img src="<?php echo $host;?>partials/images/n9.jpg" alt="" /> <span>3 The Jungle Book</span></a></td>
											<td>2014</td>
											<td>HD</td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">Japan</a></td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">Action</a></td>
											<td>7.1</td>
										  </tr>
										  <tr>
											<td>11</td>
											<td class="w3-list-img"><a href="<?php echo $host;?>pages/single.php"><img src="<?php echo $host;?>partials/images/n10.jpg" alt="" /> <span>01 Independence Day</span></a></td>
											<td>2013</td>
											<td>HD</td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">United Kingdom</a></td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/comedy.php">Comedy, Drama</a></td>
										  ...
										  <tr>
											...
											<td>HD</td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">United States</a></td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/horror.php">Horror</a></td>
											<td>7.1</td>
										  </tr>
										  <tr>
											<td>17</td>
									...
									<table id="table-breakpoint1">
										...
										<tbody>
										  <tr>
											...
											<td>HD</td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">United Kingdom</a></td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">Comedy, Drama</a></td>
											<td>7.0</td>
										  </tr>
										  <tr>
											<td>2</td>
										  ...
										  <tr>
											...
											<td>HD</td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">China</a></td>
											<td class="w3-list-info"><a href="<?php echo $host;?>pages/genres.php">Comedy</a></td>
											<td>8.9</td>
										  </tr>
										  <tr>
											<td>6</td>
