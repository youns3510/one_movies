						...
						<div class="container">
								<!-- /latest-movies -->
								   ...
								   <div class="col-md-2 w3l-movie-gride-agile">
											 <a href="<?php echo $host;?>pages/single.php" class="hvr-shutter-out-horizontal"><img src="<?php echo $host;?>partials/images/m7.jpg" title="album-name" alt=" " />
									   ...
									   <div class="col-md-2 w3l-movie-gride-agile">
											 <a href="<?php echo $host;?>pages/single.php" class="hvr-shutter-out-horizontal"><img src="<?php echo $host;?>partials/images/m8.jpg" title="album-name" alt=" " />
											 <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
										</a>
										  <div class="mid-1">
											<div class="w3l-movie-text">
										...
										<div class="col-md-2 w3l-movie-gride-agile">
											 <a href="<?php echo $host;?>pages/single.php" class="hvr-shutter-out-horizontal"><img src="<?php echo $host;?>partials/images/m9.jpg" title="album-name" alt=" " />
											 <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
										</a>
										  <div class="mid-1">
											<div class="w3l-movie-text">
										...
										<div class="col-md-2 w3l-movie-gride-agile">
											  <a href="<?php echo $host;?>pages/single.php" class="hvr-shutter-out-horizontal"><img src="<?php echo $host;?>partials/images/m10.jpg" title="album-name" alt=" " />
											 <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
										</a>
										  <div class="mid-1">
											<div class="w3l-movie-text">
										...
										<div class="ribben">
											...
											<div class="col-md-2 w3l-movie-gride-agile">
											<a href="<?php echo $host;?>pages/single.php" class="hvr-shutter-out-horizontal"><img src="<?php echo $host;?>partials/images/m11.jpg" title="album-name" alt=" " />
											 <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
										</a>
										  <div class="mid-1">
											<div class="w3l-movie-text">
										...
										<div class="col-md-2 w3l-movie-gride-agile">
											 <a href="<?php echo $host;?>pages/single.php" class="hvr-shutter-out-horizontal"><img src="<?php echo $host;?>partials/images/m12.jpg" title="album-name" alt=" " />
											 <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
										</a>
										  <div class="mid-1">
											<div class="w3l-movie-text">
