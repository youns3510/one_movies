      ...
      <div id="about">
        ...
        <div class="struct">
          ...
          <div class="row screenshot">
            <h4 class="text-center"><b class="heading">Admin Panel:</b></h4>
            <img src="/partials/images/adminpanel.png" alt="adminpanel" class="screenshot">
          </div>
          <hr>
          <div class="row">
            <h4 class="text-center"> <b class="heading">User Interface:</b></h4>
            <img src="/partials/images/HomeOneMovies.jpg" alt="HomeOneMovies" class="screenshot">
          </div>
