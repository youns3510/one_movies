...
<div class="container">
    <div class="row account">  
     <div class="col-xs-12 col-sm-12 col-md-8">
         <a href="<?php echo $host; ?>/users/pages/history.php" class="btn account-btns active">History</a>
         <a href="<?php echo $host; ?>/users/pages/favorite.php" class="btn account-btns">Favorite</a> 
